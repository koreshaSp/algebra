...
\begin{definition}
    ...
    \[
        \det A = \sum\limits_{\sigma\in S_n}
        {sgn\sigma \prod\limits_{i = 1}^{n}{a_{i, \sigma(i)}}}
    \]
\end{definition}
\begin{remark}
    Можно понимать, что определитель можно воспринимать как стандартную форму объёма
    для $\mathbb{R}^n$. Собственно про эту связь и будет разговор в следующих лекциях.
\end{remark}
